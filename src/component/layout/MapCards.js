...
const MapCards = animation => (
  ...
  >
    ...
    <View style={styles.card}>
    <Image source={require('../img/pic5.png') } style={styles.cardImage} resizeMode="cover" />
      <View style={styles.textContent}>
        <Text numberOfLines={1} style={styles.cardtitle}>
          Second Best Place
        </Text>
    ...
    <View style={styles.card}>
    <Image source={require('../img/pic6.png') } style={styles.cardImage} resizeMode="cover" />
      <View style={styles.textContent}>
        <Text numberOfLines={1} style={styles.cardtitle}>
          Third Best Place
        </Text>
    ...
    <View style={styles.card}>
    <Image source={require('../img/pic7.png') } style={styles.cardImage} resizeMode="cover" />
      <View style={styles.textContent}>
        <Text numberOfLines={1} style={styles.cardtitle}>
          Third Best Place
        </Text>
